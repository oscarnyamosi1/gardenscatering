...
const createMessage = ({firstname,lastname,email,eventtype,phonenumber,vision,date})=>{
  return `Hello gardens I would like to make a booking with you. Email : ${email} and number: ${phonenumber}. I want my event (${eventtype}) to be inspired in this way (vision: ${vision} ) on this date (${date})  . Thank you. ~ ${firstname} ${lastname}`
}
                ...
                <div>
                  ...
                  <div className="space-y-6">
                    <div className="border-l-2 border-primary pl-4">
                      ...
                      <p className="font-light text-foreground">gardenscatering@gmail.com</p>
                    </div>
                    <div className="border-l-2 border-primary pl-4">
