        ...
        <div className="container relative z-10 px-4 md:px-6 mx-auto text-center mt-[-10vh]">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-serif text-white leading-tight drop-shadow-lg">
              Best <br />
              <span className="italic text-white/90">Catering</span> for you !
            </h1>
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                Gardens Catering was born from a simple desire: to elevate the rich, vibrant flavors of the African continent to the realm of fine dining. We believe that a meal is more than sustenance—it is a story, a celebration, and a connection.
              </p>
