        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground leading-relaxed">
              Founded in 2015, gardens catering began with a singular vision: to present the complex, diverse flavors of the African continent with the refinement and precision of contemporary fine dining.
            </p>
            <p className="text-lg text-muted-foreground leading-relaxed">
          ...
          <motion.div 
            ...
            className="glass p-2 rounded-[2rem] relative"
          >
            <Image  src="https://res.cloudinary.com/dw0l7b86h/image/upload/v1781538197/IMG-20260615-WA0032_lndxzt.jpg" alt="mr . gardens" className="rounded-[1.5rem] w-full aspect-square md:aspect-[4/5] object-cover" />
          </motion.div>
          ...
          <motion.div 
            ...
            className="glass p-2 rounded-[2rem] relative"
          >
            <Image  src="https://res.cloudinary.com/dw0l7b86h/image/upload/v1781538191/IMG-20260615-WA0030_yvzm4a.jpg" alt="mr . gardens" className="rounded-[1.5rem] w-full aspect-square md:aspect-[4/5] object-cover" />
          </motion.div>
          <motion.div 
            initial={{ opacity: 0, scale: 0.95 }}
            animate={{ opacity: 1, scale: 1 }}
            ...
            className="glass p-2 rounded-[2rem] relative"
          >
            <Image  src="https://res.cloudinary.com/dw0l7b86h/image/upload/v1782392526/IMG-20230607-WA0006_hydiuh.jpg" alt="mr . gardens" className="rounded-[1.5rem] w-full aspect-square md:aspect-[4/5] object-cover" />
          </motion.div>
        </div>
      </section>
