    ...
    <div className="bg-background min-h-screen">
      ...
      <section className="relative w-full bg-[#0C0C0C]">
        ...
        <div className="relative z-10 text-center pt-40 pb-28 px-4 flex flex-col items-center">
          ...
          <h1 className="font-serif text-5xl md:text-7xl text-white mb-6">About gardens</h1>
      ...
      >
        ...
        <motion.div variants={stagger} className="space-y-6">
          ...
          <motion.h2 variants={fadeUp} className="font-serif text-4xl lg:text-5xl text-foreground">The gardens Philosophy</motion.h2>
          <motion.p variants={fadeUp} className="text-muted-foreground font-light leading-relaxed text-lg">
            Founded on the belief that every event deserves to be memorable, gardens Catering Company has been redefining culinary experiences for over a decade. Our journey started with a simple passion for bringing people together over exceptional food.
          </motion.p>
          <motion.p variants={fadeUp} className="text-muted-foreground font-light leading-relaxed text-lg">
