    ...
    <footer className="bg-[#0C0C0C] text-white pt-20 pb-8">
      <div className="container mx-auto px-4 md:px-8">
        ...
        <div className="border-b border-white/10 pb-12 mb-12 flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div>
            <h2 className="font-serif text-5xl md:text-6xl text-white mb-3">Gardens</h2>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-white/70 text-sm font-light">
                ...
                <span>+254 708 775 684</span>
              </li>
              <li className="flex items-center gap-3 text-white/70 text-sm font-light">
                <Mail size={14} className="text-primary shrink-0" />
                <span>gardenscatering@gmail.com</span>
              </li>
            </ul>
          </div>
          <div>
            ...
            <div className="flex flex-col gap-3">
              {[{icon:Facebook,label:"Facebook",link:"https://www.facebook.com/people/gardens-Kitchen-and-Bites/61578599433460/#"},
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/30 text-xs font-light">
            &copy; {new Date().getFullYear()} gardens Catering Company. All rights reserved.
          </p>
          <Link href="/booking">
