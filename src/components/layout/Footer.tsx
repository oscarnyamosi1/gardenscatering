        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <Link href="/" className="flex flex-col items-start shrink-0 mb-6">
              <span className="font-serif text-2xl font-bold tracking-wider leading-none text-primary">Gardens</span>
              <span className="font-sans text-[10px] tracking-[0.2em] uppercase mt-1 text-foreground/80">catering</span>
            </Link>
            ...
            <div className="flex space-x-4 pt-2">
              ...
              <a href="https://wa.me/254708775684?text=Hello%2C+I+wanna+inquire+about+your+catering+services&utm_source=gardensevents.vercel.app" className="w-10 h-10 rounded-full border border-border flex items-center justify-center text-foreground hover:bg-primary hover:text-primary-foreground hover:border-primary transition-colors">
