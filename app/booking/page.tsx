        ...
        <div className="min-h-[80vh] pt-12 pb-20 flex items-center justify-center">
          ...
          >
            ...
            <p className="text-muted-foreground mb-8">
              Thank you for choosing gardens catering. Our events team will review your details and contact you within 24 hours to discuss your menu and finalize the quote.
            </p>
