          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="grid md:grid-cols-2 gap-16 items-center">
              <div
                ...
                className="relative"
              >
                <div className="aspect-[4/5]  overflow-hidden glass-card p-2 relative z-10">
                  <img src="osca.png" alt="Fine dining table" className="w-full h-full object-cover rounded-8px" />
                </div>
              ...
              >
                ...
                <p className="text-muted-foreground leading-relaxed text-lg">
                  Gardens Catereing was born from a simple desire: to elevate the rich, vibrant flavors of the African continent to the realm of fine dining. We believe that a meal is more than sustenance—it is a story, a celebration, and a connection.
                </p>
        ...
        <section className="py-24 bg-card/50 relative overflow-hidden">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-16 max-w-2xl mx-auto space-y-4">
              ...
              <p className="text-muted-foreground">Catering services designed specifically for the scale and significance of your event.</p>
            </div>
